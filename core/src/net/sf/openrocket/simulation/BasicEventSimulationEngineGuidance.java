...
public class BasicEventSimulationEngineGuidance implements SimulationEngine {
	...
	private static final Logger log = LoggerFactory.getLogger(BasicEventSimulationEngineGuidance.class);
...
//				}
	...
	private FlightData computeCoastTime() throws SimulationException {
		try {
			...
			BasicEventSimulationEngineGuidance e = new BasicEventSimulationEngineGuidance();
